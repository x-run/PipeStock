...
### 3.1.3 在庫一覧ページ (`/stock`) — Phase 5 実装済

ダッシュボードの「もっと見る →」遷移先。全商品の在庫を検索・ソート・ページングで確認する。
...
│ [検索...]                     [数量 多い順 ▼]        │
├──────┬──────┬──────┬────────┬────────┬──────┬───────┤
│ Code │ 商品名│ カテゴリ│On-hand │Reserved│Avail │ 状態  │
├──────┼──────┼──────┼────────┼────────┼──────┼───────┤
│PIPE  │ステン │ステン │ 100 本 │  20    │**80**│ 正常   │
│-001  │レス…  │レス…  │        │(薄い色)│(太字)│       │
├──────┼──────┼──────┼────────┼────────┼──────┼───────┤
│PIPE  │銅パイ │銅パイ │   8 本 │   3    │ **5**│⚠ 要発注│
│-002  │プ…   │プ…   │        │(検品2) │(太字)│⚠背景色│
└──────┴──────┴──────┴────────┴────────┴──────┴───────┘
│ 50 件中 1〜20 件            [◀] 1 / 3 [▶]          │
└─────────────────────────────────────────────────────┘
